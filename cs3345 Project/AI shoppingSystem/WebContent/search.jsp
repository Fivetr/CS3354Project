...
<table>
		...
		<%
			...
			ResultSet Result = statement.executeQuery("select *from product where name like '%"+search+"%' or description like '%" +search+ "%' Order by product.name"); //get product from database
			while(Result.next()){
				hasItem = true;
		%>
          <tr>
